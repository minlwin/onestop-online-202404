...
public class SignUpController {
	...
	String signUp(
			...
			@Validated @ModelAttribute("form") SignUpForm signUpForm, 
		...
		try {
			service.createAccount(signUpForm);
			
			// Programmatic Login
			var authentication = authenticationManager.authenticate(signUpForm.getToken());
